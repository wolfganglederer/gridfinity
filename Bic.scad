...
difference(){
    union(){
       ...
       #translate([0,9, 5])bic_negative(19);
       #translate([0,-9, 5])bic_negative(19);
}

// bic_negative(10);

module bic_negative(h = 30){
resize([27,16,3])cylinder(h=2, r1 = 10, r2 = 13 );
    union(){
        translate([0,0,h])scale([2.7,1.6,1])cylinder(h=3, r1 = 5, r2 = 5.8 );
        scale([2.7,1.6,h])cylinder(h = 1, r = 5, $fn = 80);
    };
}
